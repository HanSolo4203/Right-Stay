  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="flex justify-between items-start mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Property Mapping</h2>
          <p className="text-slate-500">Map Uplisting properties to internal apartments</p>
        </div>
        <button
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-4 mb-3">
                  <div className="flex items-center space-x-2">
                    <Building2 className="w-5 h-5 text-right-stay-600" />
                    <span className="text-slate-900 font-semibold">Uplisting: {mapping.uplisting_property_id}</span>
                  </div>
                  <MapPin className="w-4 h-4 text-slate-500" />
                  <div className="flex items-center space-x-2">
                    <Building2 className="w-4 h-4 text-green-700" />
                    <span className="text-slate-900">Apartment: {mapping.apartments.apartment_number}</span>
                  </div>
                </div>
