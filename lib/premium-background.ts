...
export const PREMIUM_BASE_COLOR = "#121816";
/** Matches .premium-page-backdrop__gradient for hero → section blends */
export const PREMIUM_GRADIENT_START = "#121816";
export const PREMIUM_GRADIENT_MID = "#121816";
export const PREMIUM_GRADIENT_END = "#121816";
