    ...
    <div className="min-h-screen bg-black text-white p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">Import Reviews</h1>
          <p className="text-gray-400">Upload a markdown file to bulk import guest reviews</p>
        ...
        <div className="mb-6">
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-blue-600/20 hover:bg-blue-600/30 text-blue-400 rounded-lg border border-blue-500/30 transition-all"
          >
            ...
            <div className="bg-white/5 rounded-lg border border-white/10 p-6">
              ...
              {validationErrors.length > 0 && (
                <div className="mb-4 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                  <h3 className="font-semibold text-yellow-400 mb-2">Validation Warnings:</h3>
              ...
              <div className="mt-6 flex items-center justify-end space-x-4">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded-lg transition-all"
                >
                  {importing ? (
                    <>
                ...
                {importResult.success ? (
                  <div className="space-y-2 text-sm">
                    <p className="text-gray-300">
                      ✅ Successfully imported: <strong className="text-green-400">{importResult.imported}</strong> review(s)
                    </p>
                    ...
                    {importResult.message && (
                      <p className="text-gray-400 text-xs mt-2 italic">{importResult.message}</p>
                    )}
                  </div>
                ) : (
                  <div>
