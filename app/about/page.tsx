...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Right Stay Africa — our story, values, and team redefining hospitality across the continent.',
};
...
const values = [
  {
    ...
    description:
      "We're passionate about delivering exceptional experiences. Every property, every guest interaction, and every detail matters to us.",
  },
  {
    icon: Target,
    title: 'Integrity & Transparency',
    description:
      'Honesty is at the core of everything we do. We believe in transparent communication with both guests and property owners.',
  },
  {
    icon: Award,
    title: 'Quality First',
    description:
      'We maintain the highest standards across all our properties and services. Quality is never compromised.',
  },
  {
    icon: Users,
    title: 'Community Focused',
    description:
      "We're committed to supporting local communities and showcasing the authentic culture of Africa.",
  },
];
      ...
      <section className="isolate min-h-[500px] overflow-hidden relative">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-8 py-24">
          ...
          <p className="sm:text-xl text-lg leading-relaxed text-white/90 max-w-3xl mt-6">
            Your trusted partner for exceptional African experiences. We&apos;re redefining hospitality across the
            continent.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600">
              <p className="text-xl leading-relaxed mb-6">
                Right Stay Africa was born from a simple belief: that exceptional hospitality should be accessible,
                transparent, and authentically African.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Founded in 2020, we started with a single property in Cape Town and a vision to showcase the best of
                what Africa has to offer. Today, we manage a diverse portfolio of premium accommodations across South
                Africa, each one carefully selected to provide guests with unforgettable experiences.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                We&apos;re more than just a property management company. We&apos;re storytellers, cultural ambassadors,
                and passionate advocates for African tourism. Every property in our portfolio tells a story, and every
                guest becomes part of our extended family.
              </p>
              <p className="text-lg leading-relaxed">
                Our commitment to excellence, transparency, and authentic experiences has earned us the trust of hundreds
                of guests and property owners across the continent. We&apos;re proud to be setting new standards in
                African hospitality.
              </p>
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-right-stay-100 mb-6">
                    <Icon className="h-7 w-7 text-right-stay-500" strokeWidth={1.5} />
                  </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12">
            {team.map((member) => (
              <div key={member.name} className="text-center">
                ...
                <p className="text-right-stay-500 font-medium mb-3">{member.role}</p>
      ...
      <section className="isolate overflow-hidden py-24 relative bg-gradient-to-br from-right-stay-500 to-right-stay-600">
        <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-8 text-center">
          ...
          <p className="sm:text-xl text-lg leading-relaxed text-white/90 max-w-3xl mx-auto mt-6 mb-10">
            Whether you&apos;re looking for your next African adventure or want to partner with us, we&apos;re here to
            help.
          </p>
